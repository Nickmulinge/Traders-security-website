...
<body>
    ...
    <form action="./auth.php" method="post">
        ...
        <input type="text" placeholder="full name" id="" name="fullname">
        ...
        <button type="submit" class="submitbtn" name="createaccount">CREATE</button>
        <br><br>
        <p align="center">You have an account? <a href="./auth.php">login</a></p>
    </form>
    <script>
        function goBack() {
            window.history.back()
